/*
 * Copyright 2017-2020 original authors Licensed under the Apache License,
 ...
 */
package io.micronaut.configuration.zeebe.core.executor;
 ...
 */
@Factory
public class WorkerExecutorServiceConfig {
    ...
    ExecutorConfiguration configuration() {
        return UserExecutorConfiguration.of(ExecutorType.SCHEDULED, 16);
    }
}
